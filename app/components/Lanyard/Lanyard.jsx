...
const lanyard = '/assets/lanyard/tali-lanyard.png';
        ...
        <RigidBody ref={card} {...segmentProps} position={[2, 0, 0]} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          >
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial map={materials.base.map} clearcoat={1} clearcoatRoughness={0.15} roughness={0.9} metalness={0.8} />
            </mesh>
